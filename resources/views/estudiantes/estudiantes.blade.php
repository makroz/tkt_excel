    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="content-wrapper p-0 mt-3">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Leads / Registros <a class="btn btn-link" href="{{ route('caii.index') }}">Volver eventos</a></h4>
                          ...
                          <tbody>
                            ...
                            <tr role="row" class="odd" <?php if($datos->dtrack == "SI") echo "style='background:#a0e8c5;'"?> <?php if($datos->dtrack == "NO") echo "style='background:#f7d3d3;'"?>>
                              ...
                              <td nowrap="">
                                ...
                                <td> {{ $datos->grupo, '' }} </td>
                                <td>
                                  <span class="badge @if($datos->estudiantes_tipo_id === 1)badge-primary @elseif($datos->estudiantes_tipo_id === 2)badge-success @elseif($datos->estudiantes_tipo_id === 3)badge-danger @else badge-dark @endif ">{{ $datos->tipo->nombre,'' }}</span>
                                </td>
    ...
    <div class="modal-content">
      <form  id="f_cargar_datos_estudiantes" name="f_cargar_datos_estudiantes" method="post"  action="{{ route('estudiantes.import') }}" class="formarchivo" enctype="multipart/form-data" >
        ...
        <div class="modal-footer">
          <a href="#" class="btn btn-dark">Exportar Registros</a>
