            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample pr-4 pl-4" id="caiieventosForm" action="{{ route('caii_form.store') }}" method="post" enctype="multipart/form-data" >
                    {!! csrf_field() !!}
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea required="" placeholder="Descripción en HTML" class="form-control" name="descripcion" id="" cols="30" rows="10">{{ old('descripcion') }}</textarea>
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12 text-center mt-4">
                        ...
                        <a href="{{ route('caii_plantilla.create') }}" class="btn btn-light">Volver atrás</a>
                      </div>
