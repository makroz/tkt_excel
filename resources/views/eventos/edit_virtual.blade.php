                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <div id="datepicker-popup" class="input-group date datepicker">
                            <input required="" type="text" class="form-control form-border" name="fechai_evento" value="{!! \Carbon\Carbon::parse($datos->fechai_evento)->format('d/m/Y') !!}" placeholder="{{date('d/m/Y')}}">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <div id="datepicker-popup2" class="input-group date datepicker">
                            <input required="" type="text" class="form-control form-border" name="fechaf_evento" value="{!! \Carbon\Carbon::parse($datos->fechaf_evento)->format('d/m/Y') !!}" placeholder="{{date('d/m/Y')}}">
                            <span class="input-group-addon input-group-append border-left">
                              <span class="mdi mdi-calendar input-group-text"></span>
                            </span>
                          </div>
