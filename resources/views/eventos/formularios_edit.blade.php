            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample pr-4 pl-4" id="caiieventosForm" action="{{ route('eventos_form.update', $datos->eventos_id) }}" method="post" enctype="multipart/form-data" >
                    ...
                    {!! csrf_field() !!}
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea placeholder="Descripción en HTML" class="form-control" name="descripcion" id="" cols="30" rows="10">{{ $datos->descripcion_form }}</textarea>
